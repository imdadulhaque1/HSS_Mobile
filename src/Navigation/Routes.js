...
import InAppUpdate from '../Constants/InAppUpdate';
import DeviceCountry from 'react-native-device-country';
import { getDeviceName, getApiLevel, getSystemName, getModel } from 'react-native-device-info';
...
const Routes = () => {
  ...
  useEffect(() => {
    DeviceCountry.getCountryCode()
      .then((result) => {
        ...
        Toast.show(result.code, Toast.durations.SHORT);
      ...
      .catch((e) => {
        ...
        //eventmod
        Toast.show("device country faild", Toast.durations.SHORT);
  ...
  useEffect(() => {
    publicIP()
      .then(ip => {
        //eventmod
        Toast.show(ip, Toast.durations.SHORT);
  ...
  const getLoactionInformation = (ip = null) => {
    ...
    axios
      ...
      .then(res => {
        ...
        Toast.show('get all info from server', Toast.durations.SHORT);
